...
event_mes_data_1561_0000: .strn "私はこのＭＳＧはありません。{结束}"
event_mes_data_1561_0001: .strn "クジ引き屋ロットに{↙}ようこそ。{↙}ここではクジが引けますよ。{9023}{结束}"
event_mes_data_1561_0002: .strn "{411f}{a41f}{481f}１回{颜2}{功能1}{2708}{颜1}です。どうですか？{↙}{3223}{0008}クジを引く{↙}{0008}やめる{9023}{结束}"
event_mes_data_1561_0003: .strn "{431f}クジで試されるのは{↙}今のあなた自身。{↙}またいつでもおいでください。{结束}"
event_mes_data_1561_0004: .strn "{431f}あら、残念ですが{↙}お金が足りないようです。{9023}{结束}"
event_mes_data_1561_0005: .strn "{431f}それでは、{↙}あなたの今を{↙}試してみましょう…。{2b23}{2d23}…………！{9023}{结束}"
event_mes_data_1561_0006: .strn "こちらが賞品の{↙}{颜2}{功能2}{颜1}です。{↙}どうぞお受け取り下さい。{9023}{结束}"
event_mes_data_1561_0007: .strn "クジはあなたの運を映し出す{↙}貴重なかがみ。{↙}またいつでもおいでください。{结束}"
event_mes_data_1561_0008: .strn "ダミー{结束}"
event_mes_data_1561_0009: .strn "ダミー{结束}"
event_mes_data_1561_0010: .strn "ダミー{结束}"
event_mes_data_1561_0011: .strn "ダミー{结束}"
event_mes_data_1561_0012: .strn "ダミー{结束}"
event_mes_data_1561_0013: .strn "ダミー{结束}"
event_mes_data_1561_0014: .strn "ダミー{结束}"
event_mes_data_1561_0015: .strn "ダミー{结束}"
event_mes_data_1561_0016: .strn "ダミー{结束}"
event_mes_data_1561_0017: .strn "ダミー{结束}"
event_mes_data_1561_0018: .strn "ダミー{结束}"
event_mes_data_1561_0019: .strn "ダミー{结束}"
event_mes_data_1561_0020: .strn "＜結果はどうかな＞{结束}"
event_mes_data_1561_0021: .strn "{颜2}特賞{颜1}です！{↙}{颜2}特賞{颜1}で～す！　{↙}超大当たりです！{9023}{结束}"
event_mes_data_1561_0022: .strn "{颜2}１等{颜1}です！{↙}大当たりです！おめでとうございます！{↙}{9023}{结束}"
event_mes_data_1561_0023: .strn "{颜2}２等{颜1}です！　{↙}当たりで～す！　{↙}おめでとうございます！{9023}{结束}"
event_mes_data_1561_0024: .strn "{颜2}３等{颜1}です！　{↙}当たりです。　{↙}おめでとうございます！{9023}{结束}"
event_mes_data_1561_0025: .strn "{颜2}４等{颜1}です！{↙}プチ当たりです！　{↙}おめでとうございます！{9023}{结束}"
event_mes_data_1561_0026: .strn "{颜2}５等{颜1}です！　{↙}ミニ当たりです！　{↙}おめでとうございます！{9023}{结束}"
event_mes_data_1561_0027: .strn "うっ、残念。{↙}{2d23}ハズレでしたー。{9023}{结束}"
