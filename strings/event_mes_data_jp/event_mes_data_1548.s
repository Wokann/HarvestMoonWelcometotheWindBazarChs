...
event_mes_data_1548_0000: .strn "{401f}{索娜}{481f}{3521}{2f23}{颜3}フーチョ{颜1}{2c23}{↙}SHOP•フーチョフーチョに{↙}いらっしゃいデスだーヨ。{9023}{结束}"
event_mes_data_1548_0001: .strn "{401f}{索娜}{481f}{411f}{a41f}{481f}{3721}{3323} アイテムを見たい{↙} アイテムを売りたい{↙} なんでもない{结束}"
...
event_mes_data_1548_0007: .strn "{401f}{索娜}{481f}{3521}{颜2}{功能1}G{颜1}でいいデスだヨ？{↙}{3223} 買う{↙} やっぱりやめる{结束}"
event_mes_data_1548_0008: .strn "{401f}{索娜}{481f}{3521}{颜2}{功能1}G{颜1}でいいデスだヨ？{↙}{3223} 売る{↙} やっぱりやめる{结束}"
event_mes_data_1548_0009: .strn "{401f}{索娜}{481f}{3521}ありがとうデスだヨ！{↙}ほか、何かあるデスだヨ？{9023}{结束}"
event_mes_data_1548_0010: .strn "{401f}{索娜}{481f}{功能1}は、{↙}１個{颜2}{功能2}G{颜1}だヨ。{↙}いくつ買うデスだヨ？{9023}{0927}"
event_mes_data_1548_0011: .strn "{401f}{索娜}{481f}{功能1}は、{↙}１個{颜2}{功能2}G{颜1}だヨ。{↙}いくつ売るデスだヨ？{9023}{0927}"
