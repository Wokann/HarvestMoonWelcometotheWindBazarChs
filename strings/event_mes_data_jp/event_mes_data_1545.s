...
event_mes_data_1545_0001: .strn "{401f}{莉亚}{481f}{411f}{a41f}{481f}{3721}{3323} アイテムを見たい{↙} アイテムを売りたい{↙} なんでもない{结束}"
...
event_mes_data_1545_0007: .strn "{401f}{莉亚}{481f}{3521}では{颜2}{功能1}G{颜1}となります。{↙}{3223} 買う{↙} やっぱりやめる{结束}"
event_mes_data_1545_0008: .strn "{401f}{莉亚}{481f}{3521}では{颜2}{功能1}G{颜1}となります。{↙}{3223} 売る{↙} やっぱりやめる{结束}"
event_mes_data_1545_0009: .strn "{401f}{莉亚}{491f}{3521}どうもありがとうございます！{↙}何かほかにご用はありますで{↙}しょうか。{9023}{结束}"
event_mes_data_1545_0010: .strn "{401f}{莉亚}{481f}{功能1}は、{↙}１個{颜2}{功能2}G{颜1}です。{↙}いくつ買いますか？{9023}{0927}"
event_mes_data_1545_0011: .strn "{401f}{莉亚}{481f}{功能1}は、{↙}１個{颜2}{功能2}G{颜1}です。{↙}いくつ売りますか？{9023}{0927}"
