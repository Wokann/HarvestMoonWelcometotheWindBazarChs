...
event_mes_data_1569_0001: .strn "{411f}{a41f}{481f}{3323} アイテムを買いたい{↙} アイテムを売りたい{↙} なんでもない{结束}"
...
event_mes_data_1569_0007: .strn "{颜2}{功能1}G{颜1}になります！{↙}{3223} 買う{↙} やめる{结束}"
event_mes_data_1569_0008: .strn "{颜2}{功能1}G{颜1}でいいですか？{↙}{3223} 売る{↙} やめる{结束}"
event_mes_data_1569_0009: .strn "わかりました。{↙}確かに買い取りました。{↙}ありがとうございます！{9023}{结束}"
event_mes_data_1569_0010: .strn "{功能1}は、{↙}１個{颜2}{功能2}G{颜1}です。{↙}いくつ買いますか？{9023}{0927}"
event_mes_data_1569_0011: .strn "{功能1}は、{↙}１個{颜2}{功能2}G{颜1}です。{↙}いくつ売りますか？{9023}{0927}"
...
event_mes_data_1569_0017: .strn "あ、{名字}さん。{↙}今の売上は{↙}{颜2}{0310}G{颜1}です！{2b23}引き続き、店番頑張ります！{↙}どーんと、おまかせください！{结束}"
event_mes_data_1569_0018: .strn "あ、{名字}さん！{↙}品物は完売しましたよ♪{2b23}売上合計は{↙}{颜2}{0310}G{颜1}です！！{结束}"
