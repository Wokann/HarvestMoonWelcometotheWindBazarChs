...
event_mes_data_1547_0001: .strn "{401f}{雪莉露}{481f}{411f}{a41f}{481f}{3721}{3323} アイテムを見たい{↙} アイテムを売りたい{↙} なんでもない{结束}"
...
event_mes_data_1547_0007: .strn "{401f}{雪莉露}{481f}{3521}では{颜2}{功能1}G{颜1}になるな。{↙}{3223} 買う{↙} やっぱりやめる{结束}"
event_mes_data_1547_0008: .strn "{401f}{雪莉露}{481f}{3521}では{颜2}{功能1}G{颜1}になるな。{↙}{3223} 売る{↙} やっぱりやめる{结束}"
event_mes_data_1547_0009: .strn "{401f}{雪莉露}{491f}{3521}うむ！　なかなかいい品を{↙}買い取らせてもらったよ。{↙}ほかには何かあるかね？{9023}{结束}"
event_mes_data_1547_0010: .strn "{401f}{雪莉露}{481f}{功能1}は、{↙}１個{颜2}{功能2}G{颜1}だが{↙}いくつ買うのだね？{9023}{0927}"
event_mes_data_1547_0011: .strn "{401f}{雪莉露}{481f}{功能1}は、{↙}１個{颜2}{功能2}G{颜1}だが{↙}いくつ売ってくれるのかね？{9023}{0927}"
