...
mes_data_0016_0000: .strn "{2f23}请输入名字。{↙}按{颜2}十字键{颜1}選择，{↙}{颜2}Ａ键{颜1}确定。{结束}"
mes_data_0016_0001: .strn "{2f23}{名字}可以么？{↙}{3223}　嗯，好的。{↙}　不，错了。{↙}{结束}"
mes_data_0016_0002: .strn "{2f23}请输入名字。{↙}按{颜2}十字键{颜1}選择，{↙}{颜2}Ａ键{颜1}确定。{结束}"
mes_data_0016_0003: .strn "{2f23}名字无法输入。{↙}{9023}{2923}{结束}"
