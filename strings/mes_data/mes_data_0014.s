...
mes_data_0014_0000: .strn "{2408}{3308}无法进行无线通信{结束}"
mes_data_0014_0001: .strn "无法接收数据。{↙}{2408}{3308}无线通信结束。{结束}"
mes_data_0014_0002: .strn "发生通讯错误。{结束}"
mes_data_0014_0003: .strn "对方无应答。{↙}{3708}{4908}{0d08}{2608}{4908}中断连接。{结束}"
mes_data_0014_0004: .strn "无法接收数据。{↙}{2408}{3308}无线通信结束。{↙}请切断电源。{↙}{结束}"
