...
mes_data_0003_0000: .strn "{2e23}请選择季节。{↙}按{颜2}十字键{颜1}選择，{↙}{颜2}Ａ键{颜1}确认。{0827}{结束}"
mes_data_0003_0001: .strn "{2e23}请選择日期。{↙}按{颜2}十字键{颜1}選择，{↙}{颜2}Ａ键{颜1}确认。{0827}{结束}"
mes_data_0003_0002: .strn "{2e23}{功能1}的{功能2}日作为生日可以么？{↙}{3223}{0008}是{↙}{0008}不是{↙}{结束}"
mes_data_0003_0003: .strn "{2e23}请選择季节。{↙}按{颜2}十字键{颜1}選择，{↙}{颜2}Ａ键{颜1}确认。{0827}{结束}"
