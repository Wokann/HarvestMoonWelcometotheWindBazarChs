...
event_mes_data_0885_0002: .strn "{401f}{雪莉露}{481f}{3521}{2f23}{颜3}菲尼克斯{颜1}{2c23}{↙}这是{颜2}春茶{颜1}！{2b23}３０日的茶会上，{↙}你拿着这个来，{↙}{颜2}再交给我{颜1}就可以了。{2b23}当然，除了我给你的这个{↙}其它的只要和茶有关系{↙}什么都能啊！{2b23}{401f}{雪莉露}{4a1f}{3521}{d120}只是！！{0a27}{0a27}{2b23}{401f}{雪莉露}{481f}{3521}你要注意{颜2}变质的茶{颜1}{↙}我可是{颜2}不收{颜1}的。{结束}"
