...
event_mes_data_0409_0001: .strn "{401f}{米海尔}{4c1f}{3521}{2f23}{颜3}施密特{颜1}{2c23}{↙}{f621}因为要给父亲过生日。{↙}虽然不是很想去…{2b23}但不去的话又不行，{↙}因为那样的话很麻烦。{2b23}{401f}{米海尔}{481f}{3521}因此，暂时不能{↙}住在镇子里了。{↙}但是差不多冬天的时候{↙}就能回来了吧。{结束}"
