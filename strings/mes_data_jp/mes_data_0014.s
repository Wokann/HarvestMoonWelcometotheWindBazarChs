...
mes_data_0014_0000: .strn "DSワイヤレス通信を{↙}行うことができません。{结束}"
mes_data_0014_0001: .strn "データが{↙}受信できませんでした。{↙}DSワイヤレス通信を{↙}終了します。{结束}"
mes_data_0014_0002: .strn "通信エラーが発生しました。{结束}"
mes_data_0014_0003: .strn "相手からの応答がありません。{↙}Wi-Fiコネクションから{↙}切断します。{结束}"
mes_data_0014_0004: .strn "データが{↙}受信できませんでした。{↙}DSワイヤレス通信を{↙}終了します。{↙}電源をお切りください。{↙}{结束}"
